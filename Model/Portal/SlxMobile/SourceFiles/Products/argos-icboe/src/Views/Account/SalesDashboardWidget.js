...
const __class = declare('icboe.Views.Account.SalesDashboardWidget', [DashboardWidget], {
  ...
  setQueryArgs: function setQueryArgs(entry) {
    ...
    this.queryArgs.push([
      'erpInvoices',
      {
        _activeFilter: 'Account.Id eq "' + entry.$key + '" and (ErpStatus eq "' + this.openCode + '" or ErpStatus eq "' + this.partialPaidCode + '" or ErpStatus eq "' + this.pendingCode + '" or ErpStatus eq "' + this.paidCode + '") and ' + this.pastDays('CreateDate', this.dayValue, null),
    ...
    if (!this.queriedOnce) {
      this.queryArgs.push([
        'erpInvoices',
        {
          _activeFilter: 'Account.Id eq "' + entry.$key + '" and (ErpStatus eq "' + this.openCode + '" or ErpStatus eq "' + this.partialPaidCode + '" or ErpStatus eq "' + this.pendingCode + '" or ErpStatus eq "' + this.paidCode + '") and ' + this.pastDays('CreateDate', this.yearDays, null),
          _filterName: 'ErpStatus',
          _metricName: 'SumGrandTotal',
        },
      ], [
        'erpInvoices',
        {
          _activeFilter: 'Account.Id eq "' + entry.$key + '" and (ErpStatus eq "' + this.openCode + '" or ErpStatus eq "' + this.partialPaidCode + '" or ErpStatus eq "' + this.pendingCode + '" or ErpStatus eq "' + this.paidCode + '") and ' + this.pastDays('CreateDate', 2 * this.yearDays, this.yearDays),
          _filterName: 'ErpStatus',
          _metricName: 'SumGrandTotal',
        },
      ], [
