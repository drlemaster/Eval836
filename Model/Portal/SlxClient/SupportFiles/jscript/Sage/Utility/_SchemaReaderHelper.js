...
function (
    ...
    var widget = declare('Sage.Utility._SchemaReaderHelper', null, {
        ...
        __truthy: function(value){
            var retValue=null;
            if(value){
                if(value==="true"||value===true||value===1||value==='1'||value==='Yes'||value==='Y'){
                    retValue = true;
                }
        ...
        __createNodeItem: function(node){
            var isManadtory = typeof (node["@sme:isMandatory"]) === "undefined" ? false : node["@sme:isMandatory"],
                ...
                name = typeof (node["@name"]) === "undefined" ? ((node["name"]) === "undefined" ? "" : node["name"]): node["@name"],
                label = typeof (node["@sme:label"]) === "undefined" ? ((node["label"]) === "undefined" ? "" : node["label"]) : node["@sme:label"],
                type = typeof (node["@type"]) === "undefined" ? (typeof (node["type"]) === "undefined" ? "xs:string" : node["type"]) : node["@type"],
                ...
                value = typeof (node["@value"]) === "undefined" ? typeof (node["value"]) === "undefined" ? null : node["value"] : node["@value"];
        ...
        __addToQueue: function (node) {
            if (!this.__inQueue(this.fieldNameSearch, node[this.fieldNameSearch])) {
