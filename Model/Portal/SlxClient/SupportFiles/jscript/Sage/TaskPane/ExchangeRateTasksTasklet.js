...
function (nlsResources, _BaseTaskPaneTasklet, ExchangeRateDialog, declare, TaskPaneItem, dojoString, _Widget, _Templated) {
            ...
            this.taskItems = [
                        {
                            ...
                            securedAction: 'Entities/ExchangeRate/UpdateEntityExchangeRate'
                        }
            ];
