/*globals Sage, dojo define, slxmm */
                ...
                record.then(lang.hitch(this,
                    function(notes) {
                        ...
                        wordApp.Selection.TypeText(notesHistoryListStrings.accountText +
                            ...
                            ": " +
                            locale.format(new Date(), { selector: 'date', fullYear: true }));
                        ...
                        dojo.forEach(notes,
                            function(note) {                                
                                ...
                                if (note.CompletedDate) {
                                    ...
                                    wordApp.Selection.TypeText(locale.format(dateObject));
                                    wordApp.Selection.TypeParagraph();
                                }
