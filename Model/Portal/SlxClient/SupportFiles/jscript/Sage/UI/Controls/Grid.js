...
function (
    ...
    var widget = declare('Sage.UI.Controls.Grid', [_Widget, _LocalStorageMixin], {
        ...
        _prepareGridOptions: function () {
            ...
            if (this.previewField) {
                ...
                options.renderRow = function (obj, options) {
                    var previewFullText = (self.previewField.indexOf('.') !== -1) ? self._splitField(obj, self.previewField) : obj[self.previewField];
                    var displayText = '';
        ...
        */
                ...
                for (var i = 0; i < columns.length; i++) {
                    ...
                    if (column.field && column.field.indexOf('.') !== -1 && !column.get) {
                        column.get = function (dataItem) {
                            return self._splitField(dataItem, this.field);
                        };
                        column.set = function (dataItem) {
                            return self._setField(dataItem, this.field, dataItem[this.field]);
                        };
                    }
                    if (column.width) {
        ...
        /** 
        * Utility method - can be extracted out of Grid.js
        * 
        * @param {item} dataItem 
        ...
        * @private
        */
        _splitField: function (item, fieldProperty) {
        ...
        * @private
        */
        _setField: function (item, fieldProperty, value) {
            var sp = fieldProperty.split(".");
            var field = item;
            ...
            if (evt.target.className.indexOf('morelink') !== -1) {
                if (evt.target.className.indexOf('less') !== -1) {
                    ...
                    record.then(lang.hitch(this, function (record) {
                        ...
                        var fullNoteFieldText = (noteField.indexOf('.') !== -1) ? this._splitField(record[0], noteField) : record[0][noteField];
